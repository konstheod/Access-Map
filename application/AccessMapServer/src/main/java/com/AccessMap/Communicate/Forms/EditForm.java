...
public class EditForm {
    ...
    /**
     * Initializes a newly created EditForm object
     */
    public EditForm(){
        userName = "";
        password = "";
    ...
    /**
     * Initializes a newly created EditForm object with specific userName, password and email
     * @param userName userName
     * @param password password
     * @param email email
     */
    public EditForm(String userName, String password, String email){
    ...
    /**
     * Initializes a newly created EditForm object with specific userName, password, email, firstName and lastName
     * @param userName userName
     * @param password password
     * @param email email
     ...
     */
    public EditForm(String userName, String password, String email, String firstName, String lastName){
        this.userName = userName;
        this.password = password;
        this.email = email;
    ...
    /**
     * Initializes a newly created EditForm object with specific userName, password, email, firstName, lastName, address, phoneNumber and emergencyCall
     * @param userName userName
     * @param password password
     * @param email email
     * @param firstName firstName
